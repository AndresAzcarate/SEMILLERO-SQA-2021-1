...
public class BuyTicketStepDefinitions {
    ...
    public void that_a_web_user_wants_to_access_Avianca_Airlines() throws InterruptedException {
        registerPageSteps.openBrowser();
    }
    @When("^i have filled in the necessary fields$")
    public void i_have_filled_in_the_necessary_fields() throws InterruptedException, IOException {
        registerPageSteps.buyTicket();
    }
    @Then("^you should see the flight that has been selected$")
    public void you_should_see_the_flight_that_has_been_selected() throws InterruptedException, IOException {
